...
Write-Host "Karoshi Development Environment Setup" -ForegroundColor Magenta
Write-Host @"

To set up your machine for Karoshi development, this script will do the following:
...
To use Karoshi on Windows, Cargo needs to be installed.
...
Write-Host
Write-Host "Your machine has been setup for Karoshi development!"