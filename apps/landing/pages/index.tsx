...
export default function Home() {
  ...
  const appInterface = new URL(`${url}/app-interface-shadow.png`);
          ...
          */}
          ...
          <section className="fade-in-down container grid justify-center gap-6 pt-48">
            ...
            <div className="grid justify-center gap-4 sm:grid-cols-2 md:max-w-[56rem] md:grid-cols-3">
              <div className="relative overflow-hidden rounded-lg border border-slate-200  bg-white dark:border-gray-200 dark:bg-gray-200 p-1 shadow-2xl">
                <div className="flex h-[180px] flex-col justify-between rounded-md bg-gray-850 p-6 text-slate-200">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-bold text-slate-100">Simple design</h3>
              ...
              <div className="relative overflow-hidden rounded-lg border border-slate-200 bg-white p-1 shadow-2xl">
                <div className="flex h-[180px] flex-col justify-between rounded-md bg-gray-850 p-6 text-slate-200">
                  <svg viewBox="0 0 24 24" className="h-12 w-12 fill-current">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-bold text-slate-100">Optimized & Powerful</h3>
                    <p className="text-sm text-slate-100">
              ...
              <div className="relative overflow-hidden rounded-lg border border-slate-200 bg-white p-1 shadow-2xl">
                <div className="flex h-[180px] flex-col justify-between rounded-md bg-gray-850 p-6 text-slate-200">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-bold text-slate-100">Lightweight</h3>
                    <p className="text-sm text-slate-100">
              ...
              <div className="relative overflow-hidden rounded-lg border border-slate-200 bg-white p-1 shadow-2xl">
                <div className="flex h-[180px] flex-col justify-between rounded-md bg-gray-850 p-6 text-slate-200">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-bold text-slate-100">Built for your keyboard</h3>
                    <p className="text-sm text-slate-100">
              ...
              <div className="relative overflow-hidden rounded-lg border border-slate-200 bg-white p-1 shadow-2xl">
                <div className="flex h-[180px] flex-col justify-between rounded-md bg-gray-850 p-6 text-slate-200">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-bold text-slate-100">Open Source</h3>
                    <p className="text-sm text-slate-100">Chronowise is open source and free to use.</p>
                  </div>
                </div>
              </div>
              <div className="relative overflow-hidden rounded-lg border border-slate-200 bg-white p-1 shadow-2xl">
                <div className="flex h-[180px] flex-col justify-between rounded-md bg-gray-850 p-6 text-slate-200">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-bold text-slate-100">And Much More!</h3>
                    <p className="text-sm text-slate-100">
